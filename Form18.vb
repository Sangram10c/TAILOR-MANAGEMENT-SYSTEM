...
Public Class Form18
    ...
    Private Sub PD_PrintPage(sender As Object, e As PrintPageEventArgs) Handles PD.PrintPage
        ...
        'range from top
        e.Graphics.DrawString("RM TAILOR KADEGAON", f14, Brushes.Black, centermargin, 5, center)
        e.Graphics.DrawString("AT BUS STAND", f10, Brushes.Black, centermargin, 25, center)
